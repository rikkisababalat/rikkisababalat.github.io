        ...
        window.onload = () => {
            ...
            if (diagnoses.length > 0) {
                // Tampilkan diagnosis dengan skor tertinggi terlebih dahulu
                const topDiagnosisId = [...diagnoses].sort((a,b) => b.matchScore - a.matchScore)[0].id;
                renderDetails(topDiagnosisId);
            }
            createChart();
            loadQuiz();
        };